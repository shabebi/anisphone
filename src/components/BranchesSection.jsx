...
export default function BranchesSection({
  ...
  const content = {
    en: {
      ...
      title:
        "Visit Anis Phone Store near you — trusted service and exclusive experience",
      description:
    ...
    ar: {
      branchLabel: "فروع أنيس فون المعتمدة",
      title:
        "فروع أنيس فون العربية صارت تجربة تسوق ملموسة وخدمة استثنائية",
      description:
    ...
    benefits: {
      en: [
        ...
        },
        {
          ...
          description:
            "Delivery within hours in major cities",
          icon: "truck",
        },
        {
          id: "tradein",
          ...
          description:
            "Exchange your old device and get an immediate valuation",
          icon: "trade",
        },
        {
          id: "support",
          ...
          description:
            "Our team is ready to help with setup, data transfer, and settings",
          icon: "support",
        },
      ],
      ...
      ar: [
        {
          ...
          description:
            "تغطية شاملة ضد العيوب التصنيعية واستبدال فوري",
          icon: "shield",
        },
        {
          id: "vip",
          ...
          description:
            "توصيل خلال ساعات بنفس اليوم في المدن الرئيسية",
          icon: "truck",
        },
        {
          id: "tradein",
          ...
          description:
            "استبدل جهازك القديم بأعلى تقييم فوري مع الاستلام",
          icon: "trade",
        },
        {
          id: "support",
          ...
          description:
            "دعم شخصي لمساعدتك في نقل البيانات وضبط الإعدادات",
          icon: "support",
        },
      ],
    },
  ...
  const current = isArabic
    ? {
      ...content.ar,
      benefits: content.benefits.ar,
    }
    : {
      ...content.en,
      benefits: content.benefits.en,
    };
